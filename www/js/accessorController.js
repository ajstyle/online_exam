...
todoApp.controller("studentPasswordCtrl", function($scope, $ionicPlatform, $http, $cordovaSQLite, $location, AccessorAuth, md5, $ionicLoading, $ionicPopup) {
    ...
    $scope.getData = function() {
        ...
        $http.get('http://192.168.1.5/exam/index.php/api_acc/allbatch/aid/' + response.aid + '/format/json')
            .then(
                function(response) {
                    // success callback
...
todoApp.controller("viewPasswordCtrl", function($scope, $ionicPlatform, $http, $location, AccessorAuth, md5, $ionicLoading, $ionicPopup, $filter, $stateParams) {
    $scope.viewPassword = function() {
        ...
        $http.get('http://192.168.1.5/exam/index.php/api_acc/users/bid/' + $stateParams.bid + '/format/json')
            .then(
                function(response) {
                    // success callback
    ...
    $scope.createPdf = function(password) {
        ...
        function buildTableBody(data, columns) {
          var body = [[ {text : 'ID', style: 'subheader'},
                {text : 'Batch ID',style : 'subheader'} ,
                {text : 'Batch Name' , style: 'subheader'} ,
                {text : 'Batch City' , style: 'subheader'},
                {text : 'Username' , style: 'subheader' } ,
                {text :  'Password' , style: 'subheader'}
   ...
   header2: {
    ...
    header3: {
      ...
      alignment: 'right' ,
        ...
        pdfMake.createPdf(docDefinition).download('bits2btc-invoice.pdf');
...
todoApp.controller("pendingAssessmantCtrl", function($scope, $ionicPlatform, $http, $location, AccessorAuth, md5, $ionicLoading, $ionicPopup) {
    ...
    $http.get('http://192.168.1.5/exam/index.php/api_acc/pending_assesment/aid/' + response.aid + '/gid/' + response.gid + '/format/json')
        .then(
            function(response) {
                // success callback
...
todoApp.controller("completeAssessmantCtrl", function($scope, $ionicPlatform, $http, $location, AccessorAuth, md5, $ionicLoading, $ionicPopup) {
    ...
    $http.get('http://192.168.1.5/exam/index.php/api_acc/complete_assesment/aid/' + response.aid + '/gid/' + response.gid + '/format/json')
        .then(
            function(response) {
                // success callback
...
todoApp.controller("attemptAssessmantCtrl", function($scope, $ionicPlatform, $http, $location, AccessorAuth, md5, $ionicLoading, $ionicPopup) {
    ...
    $http.get('http://192.168.1.5/exam/index.php/api_acc/upcoming_assesment/aid/' + response.aid + '/gid/' + response.gid + '/format/json')
        .then(
            function(response) {
                // success callback
