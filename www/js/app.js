...
todoApp.directive('myRepeatDirective', function(ionicMaterialMotion, ionicMaterialInk) {
  ...
  todoApp.controller("QuizsController", function($scope, $ionicPlatform, $stateParams, $cordovaSQLite, $location,$timeout, md5,Auth){
    // Container for the categories in this Scope.
    $scope.quizs = [];
...
/**
  ...
  todoApp.controller("AccessController", function($scope, $ionicPlatform, $ionicLoading, $sce, $stateParams, $cordovaSQLite, $location,OptionId,Auth){
    // Container for the categories in this Scope.
    $scope.queses = [];
      $scope.queses_i = [];
      $scope.index = 1;
